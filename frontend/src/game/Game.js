                    ...
                    <div className="play-zone">
                            ...
                            }
                            {
                                ...
                                <div className="word-row">
                                    <span className="guess-word">{game_status.current_word['word']}</span>
                                    {
                                        ...
                                        <span className="right-translation">{game_status.current_word['translation']}</span>
                                    }
                                </div>
                            }
                        ...
                        <div className="info-zone column">
                            ...
                            <div className="statistic column">
                                <span className="statistic-record">words {this.state.game_running ? game_status.guessed_words.length + game_status.words_to_guess.length + 1 : this.get_words_to_guess().length}</span>
                                <span className="statistic-record">to guess {this.state.game_running ? game_status.words_to_guess.length+1 : 0}</span>
                                <span className="statistic-record">accuracy {this.state.play_accuracy === null ? 'N/A' : '100%'}</span>
                            </div>
                        </div>
                    </div>
                </div>
